...
const EXAMPLES = [
  ...
  makeExample('laugh', () => require('./animations/laugh.json')),
  makeExample('snowcation', () => require('./animations/snowcation.json')),
  makeExample('wow', () => require('./animations/wow.json'))
    ...
    return (
      <View style={{ flex: 1 }}>
        <ExamplePicker
          ...
          onChange={(e, index) => {
            this.stopAnimation()
            this.setState({ example: EXAMPLES[index] }, () => this.stopAnimation())
          }}
        />
        <TouchableOpacity style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}
          onPress={() => {
            this.stopAnimation()
            this.setState({ example: EXAMPLES[12] }, () => this.onPlayPress())
          }}
          activeOpacity={1}
        >
          <LottieView
